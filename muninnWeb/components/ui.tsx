...
function Checkbox({ checked, onChange, label, ...rest }: any) {
  return (
...
function Radio({ checked, onChange, name, value, label }: any) {
  return (
...
function Tag({ children, removable, onRemove }: any) {
  return (
...
// ---------- Dropdown ----------
function Dropdown({ trigger, children, align = "right" }: any) {
...
function MenuItem({ icon, danger, children, ...rest }: any) {
...
// ---------- Toast ----------
function Toast({ tone = "default", title, desc }: any) {

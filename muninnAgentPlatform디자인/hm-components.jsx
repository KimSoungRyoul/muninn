...
function BrandLogo({ size = 36, color, title = "Huginn & Muninn" }) {
  ...
  return (
    <svg
      ...
      width={size}
      height={h}
      viewBox={window.__BRAND_LOGO_VIEWBOX || "0 0 1151 1000"}
      fill={color || "currentColor"}
      fillRule="evenodd"
      style={{display:"inline-block", flexShrink:0}}
    >
      <title>{title}</title>
      <path d={window.__BRAND_LOGO_PATH || ""}/>
    </svg>
  );
}

Object.assign(window, { HuginnLogo, MuninnLogo, RavenLockup, RavenMark, BrandLogo });
...
Object.assign(window, { fmtMoney, fmtMoneyK, fmtTokens, fmtDuration, fmtTimeAgo, fmtClock,
  StatusDot, StatusLabel, RuneGlyph, RavenMark, BrandLogo,
